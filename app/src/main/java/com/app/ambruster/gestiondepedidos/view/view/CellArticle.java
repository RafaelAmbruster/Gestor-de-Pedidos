...
public class CellArticle extends ViewCell<adArticle> {
    ...
    public void fill() {
        if (getObject() != null) {
            ...
            if (getObject().getArtcode() != null)
                this.code.setText(getObject().getArtcode());
            name.setText(getObject().getArtname());
