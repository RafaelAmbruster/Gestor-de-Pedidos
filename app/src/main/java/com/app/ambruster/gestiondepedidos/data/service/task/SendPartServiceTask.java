...
public class SendPartServiceTask {

    SendPartServiceTaskCallBack callBack;

    public SendPartServiceTask(SendPartServiceTaskCallBack callBack) {
        this.callBack = callBack;
    }

    public void CallService(final adUser user, final adPartObra partObra) {

        String tag_string_req = "send_part";
        String url = ServiceManager.getInstance().getURL(23).toString();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jObj.getString("success").equals("true")) {
                        callBack.onSendPartServiceTaskCallBack(true);

                    } else {
                        callBack.onSendPartServiceTaskCallBack(false);
                    }
    ...
    public interface SendPartServiceTaskCallBack {
        void onSendPartServiceTaskCallBack(Boolean status);
